      ...
      <div class="animate form login_form">
        <section class="login_content">
          ...
          <form action="../netting/islem.php" method="POST">
            ...
            <div>
            <button style="width: 100%; background-color: #73879C; color:white;" type="submit" name="admingiris" class="btn btn-default"> Daxil Olmaq</button>
            ...
            <div class="separator">
             ...
             ?>
              ...
              <div>
                <h1><i class="fa fa-paw"></i> Bahram Ali</h1>
                <p>©2018 Bahram Ali </p>
              </div>
            </div>
          </form>
