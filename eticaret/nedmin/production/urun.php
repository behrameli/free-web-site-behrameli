      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            ...
            <div align="right">
              <a href="urun-ekle.php"><button class="btn btn-success btn-xs"> Yenisini Əlavə Et</button></a>
          ...
          <div class="x_content">
            ...
            <td><center><a href="urun-duzenle.php?urun_id=<?php echo $uruncek['urun_id']; ?>"><button class="btn btn-primary btn-xs">Düzəltmək</button></a></center></td>
